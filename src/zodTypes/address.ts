...
export const addressStreet = z
    .string()
    .max(120, "Rua excede 120 caracteres");
export const addressNumber = z
    .number()
    .min(1, "Número da casa é menor que 1")
...
export const addressCity = z
    .string()
    .max(100, "Cidade excede 100 caracteres");
